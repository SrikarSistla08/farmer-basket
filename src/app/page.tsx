  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8">
          <h1 className="text-6xl font-bold text-white mb-6">
            <TypingAnimation 
              ...
              staticTextClassName="text-8xl font-extrabold"
              loop={true}
            />
          </h1>
          <p className="text-2xl text-white mb-8">Fresh from the farm to your table</p>
          <Link
            href="/shop"
            className="inline-block bg-white text-green-600 px-8 py-4 rounded-full font-semibold hover:bg-gray-100 transition-colors text-lg shadow-lg hover:shadow-xl"
          >
            Shop Fresh Products
          </Link>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        {/* Our Story */}
        <section id="os" className="relative mx-auto mb-16">
          {/* Pattern Background */}
          ...
          <div className="relative p-8 sm:p-12">
            <h2 className="text-4xl font-bold text-center mb-16 text-gray-800">Our Story</h2>

            {/* First Subsection */}
            <div className="flex flex-col md:flex-row items-center gap-8 mb-20 bg-white p-6 rounded-2xl shadow-lg">
              ...
              <div className="md:w-1/2">
                <h3 className="text-3xl font-bold text-green-600 mb-4">From Farm to Table</h3>
            ...
            {/* Second Subsection */}
            <div className="flex flex-col md:flex-row-reverse items-center gap-8 bg-white p-6 rounded-2xl shadow-lg">
              <div className="md:w-1/2">
                <div className="relative h-[400px] w-full rounded-lg overflow-hidden shadow-xl">
                  <Image
              ...
              <div className="md:w-1/2">
                <h3 className="text-3xl font-bold text-green-600 mb-4">Building Community</h3>
                <p className="text-lg text-gray-700 mb-4">
        ...
        <section className="relative mx-auto mb-16">
          ...
          <div className="relative p-8 sm:p-12">
            <h2 className="text-4xl font-bold text-center mb-16 text-gray-800">How We Work</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-lg text-center">
                ...
                <h3 className="text-xl font-bold text-green-600 mb-2">Farm Selection</h3>
                <p className="text-gray-700">We carefully select local farms that meet our high standards for sustainable and ethical farming practices.</p>
              </div>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-lg text-center">
                ...
                <h3 className="text-xl font-bold text-green-600 mb-2">Quality Check</h3>
                <p className="text-gray-700">Each product undergoes rigorous quality checks to ensure freshness and meet our premium standards.</p>
              </div>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-lg text-center">
                ...
                <h3 className="text-xl font-bold text-green-600 mb-2">Direct Delivery</h3>
                <p className="text-gray-700">Products are delivered directly from farms to your doorstep, minimizing handling and ensuring freshness.</p>
              </div>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-lg text-center">
                ...
                <p className="text-gray-700">We maintain close relationships with our customers, ensuring their needs are met and feedback is valued.</p>
              </div>
        </div>
        ...
        <section id="categories" className="relative mx-auto text-center mb-16">
        ...
        {/* Call to Action */}
        <section className="bg-gradient-to-r from-green-400 to-green-600 rounded-2xl p-8 text-center shadow-lg">
          <h2 className="text-3xl font-bold mb-4 text-white">Ready to Shop?</h2>
          <p className="text-lg text-white mb-6">Browse our selection of fresh, local products</p>
          <Link
          href="/shop"
            className="inline-block bg-white text-green-600 px-8 py-3 rounded-full font-semibold hover:bg-gray-100 transition-colors shadow-lg hover:shadow-xl"
        >
            Start Shopping
          </Link>
        </section>
