    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-24">
        ...
        <section className="relative mb-8 sm:mb-12 md:mb-16">
          ...
          <div className="relative p-4 sm:p-8 md:p-12 text-center">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-800 mb-4 sm:mb-6">About TheValleyCo</h1>
            <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
              We&apos;re more than just a farm - we&apos;re a community dedicated to sustainable agriculture and bringing fresh, local produce to your table.
            </p>
          </div>
        </section>
      ...
      <footer className="relative min-h-screen bg-gray-50">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 md:gap-12">
            {/* Contact Information */}
            <div id="contact" className="bg-white p-4 sm:p-6 md:p-8 rounded-2xl shadow-lg">
