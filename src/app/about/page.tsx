      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <section className="relative mb-16">
          ...
          <div className="relative p-8 sm:p-12 text-center">
            <h1 className="text-5xl font-bold text-gray-800 mb-6">About TheValleyCo</h1>
            ...
            {[
              ...
              <div key={index} className="bg-white p-6 rounded-2xl shadow-lg">
                <div className="flex flex-col md:flex-row gap-8 items-center">
                  <div className="relative h-64 w-64 rounded-lg overflow-hidden border-4 border-green-600 shadow-lg">
                    <Image
                      src={member.image}
                      alt={member.name}
                      fill
                  ...
                  <div className="text-center md:text-left">
                    <h3 className="text-2xl font-bold text-green-600">{member.name}</h3>
